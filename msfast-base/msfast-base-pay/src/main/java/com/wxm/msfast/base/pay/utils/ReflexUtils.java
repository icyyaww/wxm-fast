package com.wxm.msfast.base.pay.utils;

import com.wxm.msfast.base.common.enums.BaseExceptionEnum;
import com.wxm.msfast.base.common.exception.JrsfException;
import com.wxm.msfast.base.pay.common.rest.request.OrderSubmitRequest;
import com.wxm.msfast.base.pay.common.rest.response.PayDataResponse;
...
public class ReflexUtils {
    ...
    public static Class<? extends OrderSubmitRequest> getOrderSubmitRequest(IWxPayService service) {
        Class clazz = service.getClass();
        while (clazz.getSimpleName().contains("$")) {
            clazz = (Class) clazz.getGenericSuperclass();
        }

        Class<? extends OrderSubmitRequest> clsViewModel = getParameterizedType(clazz, IWxPayService.class, OrderSubmitRequest.class);

        return clsViewModel;
    }

    public static <T> Class<? extends PayDataResponse> getServiceView(IWxPayService service) {
        Class clazz = service.getClass();
        while (clazz.getSimpleName().contains("$")) {
            clazz = (Class) clazz.getGenericSuperclass();
        }

        Class<? extends PayDataResponse> clsViewModel = getParameterizedType(clazz, IWxPayService.class, PayDataResponse.class);
