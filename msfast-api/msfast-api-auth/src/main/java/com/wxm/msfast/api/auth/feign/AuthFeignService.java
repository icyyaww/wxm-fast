package com.wxm.msfast.api.auth.feign;

import com.wxm.msfast.api.auth.fallback.AuthFeignServiceFallBack;
import com.wxm.msfast.api.auth.rest.request.LoginUserRequest;
import com.wxm.msfast.api.auth.rest.response.LoginUserResponse;
