package com.wxm.nostalgia.common.rest.response.admin.user;
 ...
 * @description:
 * @author: Mr.Wang
 * @create: 2023-02-15 17:46
 **/

@Data
public class UserIdentityPageResponse {
     ...
     * 用户资料状态
     */
    @ApiModelProperty(value = "用户身份认证状态 EXAMINE(\"审核中\"),\n" +
            "    PASS(\"通过\"),\n" +
            "    REFUSE(\"拒绝\")")
